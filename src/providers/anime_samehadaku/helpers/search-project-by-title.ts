...
export default async function searchProjectByTitle(title: string): Promise<IProjectResult | null> {
    ...
    return await parseDetailUrl(detailUrl);
}



async function parseDetailUrl(detailUrl: string):Promise<IProjectResult> {
